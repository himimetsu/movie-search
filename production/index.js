...
var omdb = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, page) {
    var result, url, promisesRating;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            result = [];
            url = "https://www.omdbapi.com/?s=".concat(name, "&page=").concat(page, "&apikey=b3bbe1b3");
            _context2.next = 4;
          ...
          case 4:
            promisesRating = result.map( /*#__PURE__*/function () {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        link = "https://www.omdbapi.com/?i=".concat(item.imdbID, "&apikey=b3bbe1b3");
                        _context.next = 3;
                        return fetch(link).then(function (res) {
                          return res.json();
                        }).then(function (data) {
                          item.Link = "https://www.imdb.com/title/".concat(data.imdbID);
            ...
            _context2.next = 7;
            return Promise.all(promisesRating);
...
// CONCATENATED MODULE: ./src/components/slider/slide/slide.js



var title = function title(name, url) {
  var div = document.createElement('div');
...
var slide_poster = function poster(path) {
  var div = document.createElement('div');
  div.classList.add('poster');

  if (path === 'N/A') {
    div.style = "background:url('".concat(img_default, "')");
  } else {
    div.style = "background:url('".concat(path, "')");
  }
...
var score = function score(value) {
  var div = document.createElement('div');
...
var slide_slide_slide = function slide(film) {
  var div = document.createElement('div');
  div.classList.add('swiper-slide');
  div.appendChild(title(film.Title, film.Link));
  div.appendChild(slide_poster(film.Poster));
  div.appendChild(year(film.Year));
  div.appendChild(score(film.Score));
  return div;
};

/* harmony default export */ var slider_slide_slide = (slide_slide_slide);
// CONCATENATED MODULE: ./src/components/slider/slider.js
function slider_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function slider_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { slider_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { slider_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
function getTranslate_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { getTranslate_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { getTranslate_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

var getTranslate_translate = /*#__PURE__*/function () {
  var _ref = getTranslate_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(word) {
    var trans, url;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            trans = '';
            url = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20200502T183210Z.a1be0af551638071.2c5c96f21e02eb3e9e57602385a8ec468ffcb181&text=".concat(word, "&lang=ru-en");
            _context.next = 4;
            return fetch(url).then(function (res) {
              return res.json();
            }).then(function (data) {
...
var App_render = /*#__PURE__*/function () {
  var _ref = App_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var body, frag, swiper;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            frag.appendChild(containers_header_header());
            _context2.t0 = frag;
            _context2.next = 6;
            return containers_main_main();
          ...
          case 6:
            ...
            frag.appendChild(containers_footer_footer());
